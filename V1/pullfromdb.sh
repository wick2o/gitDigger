...
mysql -h172.16.1.122 -uroot -ptoor -Dgitdigger -N -e 'SELECT name FROM emails ORDER BY count DESC' | awk '{split($0,array,"@"); print array[1]}' | sort | uniq -c | sort -n -r > email_usernames.txt
